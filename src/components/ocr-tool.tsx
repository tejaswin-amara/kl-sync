  ...
  return (
    ...
    >
      <div className="p-5 border-b border-white/5 flex items-center gap-3 bg-zinc-950/30">
        ...
        <span className="ml-auto text-[10px] font-bold uppercase tracking-wider text-blue-400 bg-blue-500/10 px-2 py-1 rounded-full border border-blue-500/20">
          Client-Side
        </span>
      </div>
      <div className="p-6 flex flex-col md:flex-row gap-6">
        <div className="flex-1 flex flex-col gap-4">
          <p className="text-sm text-zinc-400">
            Upload notes, assignments, or circulars to instantly extract text
            directly in your browser without hitting any limits.
          </p>
