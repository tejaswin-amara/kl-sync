...
export const Card = React.forwardRef<HTMLDivElement, CardProps>(({ className, variant = 'default', ...props }, ref) => (
  <div ref={ref} className={cn('overflow-hidden rounded-[--radius-lg] text-card-foreground', variantStyles[variant], className)} {...props} />
));
...
export const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(({ className, ...props }, ref) => (
  <h3 ref={ref} className={cn('font-heading text-base font-semibold leading-tight tracking-[-0.015em] text-foreground', className)} {...props} />
));
CardTitle.displayName = 'CardTitle';

export const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn('text-xs font-normal leading-relaxed tracking-normal text-muted-foreground', className)} {...props} />
));
...
export const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn('flex items-center border-t border-border/70 p-5 pt-3', className)} {...props} />
));
