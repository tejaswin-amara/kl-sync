...
import { fetchTimetableData, ScraperSession } from '@/lib/scraper';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await fetchTimetableData(session, csrfToken || session.csrfToken, academicYear, semesterId);
