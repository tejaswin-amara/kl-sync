...
function postProcessOCRText(text: string): string {
  ...
  processed = processed.replace(/\b(\d{2})C\/(\d{3,4}[A-Z]*)\b/g, '$1CI$2') // e.g., 23C/2001 -> 23CI2001
  processed = processed.replace(/\b(\d{2}[A-Z]+)\/(\d{3,4}[A-Z]*)\b/g, '$1$2') // e.g., 23SC/3201 -> 23SC3201
