...
export default function LibraryPage() {
  ...
  return (
    <div className="flex flex-col gap-5 w-full animate-up">
      <PageHeader title="Library" description="Library records from ERP" />
      <div className="rounded-[--radius-xl] bg-surface-1 border border-border overflow-hidden">
        {loading ? (
          ...
          <EmptyState icon={<BookOpen className="w-10 h-10 text-muted-foreground/30" />} title="No library data" description="Library records will appear here." />
        ) : (
