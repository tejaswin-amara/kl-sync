...
export default function HostelsPage() {
  ...
  return (
    <div className="flex flex-col gap-5 w-full animate-up">
      <PageHeader title="Hostel Information" description="Hostel allocation data from ERP" />
      <div className="rounded-[--radius-xl] bg-surface-1 border border-border overflow-hidden">
        {loading ? (
          ...
          <EmptyState icon={<Building2 className="w-10 h-10 text-muted-foreground/30" />} title="No hostel data" description="Hostel allocation will appear here." />
        ) : (
