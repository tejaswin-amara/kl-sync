  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      <div>
        ...
        <p className="text-base text-zinc-400 mt-1">Live occupancy details synced securely from the ERP.</p>
      </div>
      ...
      <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-2xl overflow-hidden min-h-[400px]">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-[400px] text-center">
            ...
            <p className="text-base text-zinc-400">No hostel room allocation found.</p>
          </div>
        ) : (
