...
export default function HostelsPage() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-zinc-100">Hostel Room Info</h2>
        <p className="text-base text-zinc-400 text-gray-400 mt-1">Live occupancy details synced securely from the ERP.</p>
      </div>
      ...
      <div className="card bg-zinc-900/40 backdrop-blur-xl border border-white/5 overflow-hidden min-h-[400px]">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-[400px] text-center">
            ...
            <p className="text-base text-zinc-400 text-gray-400">No hostel room allocation found.</p>
          </div>
        ) : (
