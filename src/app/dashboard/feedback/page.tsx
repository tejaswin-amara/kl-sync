export default function FeedbackPage() {
  return (
    <div className="flex flex-col gap-6 w-full">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-zinc-100 capitalize">feedback</h2>
        <p className="text-base text-zinc-400 text-gray-400 mt-1">Manage your feedback details seamlessly.</p>
      </div>
