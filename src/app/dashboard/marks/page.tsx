  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-zinc-100">Academic Marks</h2>
      ...
      <div className="card bg-zinc-900/40 backdrop-blur-xl border border-white/5 overflow-hidden min-h-[400px]">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-[400px] text-center">
            ...
            <p className="text-base text-zinc-400 text-gray-400">No data found in the ERP table.</p>
          </div>
        ) : (
